...
public class DiaryAdapter extends FirestoreRecyclerAdapter<Note, DiaryAdapter.NoteViewHolder> {
    Context context;

    public DiaryAdapter(@NonNull FirestoreRecyclerOptions<Note> options, Context context) {
        super(options);
