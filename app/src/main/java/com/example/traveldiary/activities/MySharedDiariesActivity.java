...
public class MySharedDiariesActivity extends AppCompatActivity implements NotesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_shared_diaries);
        ...
        class GetNotesTask extends AsyncTask<Void, Void, List<Note>> {
            ...
            protected List<Note> doInBackground(Void... voids) {
                return NoteDataBase
                        ...
                        .noteDao().getMySharedNotes(true, user.getEmail());
            }
